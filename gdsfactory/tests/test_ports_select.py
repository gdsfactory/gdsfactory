...
def test_get_ports() -> None:
    c = gf.components.mzi_phase_shifter(length_x=123)
    ...
    p_optical_west = c.get_ports_dict(prefix="W", port_type="optical")
    p_optical_east = c.get_ports_dict(prefix="E", port_type="optical")
