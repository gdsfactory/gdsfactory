...
def route_bundle(
    ...
    Args:
        ...
        bend: bend spec or ordered sequence of bend specs. When a sequence is provided,
            the bends are applied in order along the route and the last bend is reused
            for any remaining corners.
