...
def route_bundle_same_axis_no_grouping(
    component: Component,
    ports1: list[Port],
    ports2: list[Port],
    sep: float = 5.0,
    ...
    **kwargs,
    ...
    Compared to route_bundle_same_axis, this function does not do any grouping.
