...
def spiral_racetrack_fixed_length_factory(
    length: float = 1000,
...
def spiral_racetrack_heater_metal_factory(
    min_radius: float | None = None,
...
def spiral_racetrack_heater_doped_factory(
    min_radius: float | None = None,
    straight_length: float = 30,
    spacing: float = 2,
    num: int = 8,
