...
def mzi(
    ...
    Args:
        ...
        add_all_ports: if true, all other ports in the arms are returned, relabeled as "top_X" and "bot_X" with X the arm port names
    ...
    if add_all_ports:
        c.add_ports(sxt.get_ports_list(), prefix="top_")
        c.add_ports(sxb.get_ports_list(), prefix="bot_")
