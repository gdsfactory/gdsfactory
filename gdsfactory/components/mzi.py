...
def mzi(
    ...
    Args:
        ...
        add_optical_ports: if true, all other optical ports in the arms are returned, relabeled as "top_X" and "bot_X" with X the arm port names
