...
def to_schematic_recursive(
    component: Component,
    component_suffix: str = "",
    to_schematic_func: Callable = to_schematic,
    get_instance_name: Callable[..., str] = get_instance_name_from_alias,
    **kwargs,
) -> dict[str, Any]:
    ...
    Args:
        ...
        to_schematic_func: function to extract individual netlists.
        get_instance_name: function to get instance name.
        kwargs: additional keyword arguments to pass to to_schematic_func.
