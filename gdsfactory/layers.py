...
def write_lyp(filename, layer_colors):
    """Creates a KLayout .lyp Layer Properties file from a gdsfactory LayerMap"""
    ...
    with open("%s" % filename, "w+") as f:
        ...
        for layer in layer_colors.keys():
            print(layer)
            print(layer_colors[layer])
            # Extracting information from dictionary layer by layer
            gds_layer = layer_colors[layer].gds_layer
