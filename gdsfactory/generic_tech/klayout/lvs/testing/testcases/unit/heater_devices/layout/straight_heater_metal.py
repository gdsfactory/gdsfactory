...
c8_mk = c << gf.components.rectangle(size=(120, 100), layer=straight_heater_metal_mk)
...
c10_mk = c << gf.components.rectangle(size=(500, 500), layer=straight_heater_metal_mk)
