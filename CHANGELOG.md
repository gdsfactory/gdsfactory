...
- make `snap_references_to_grid=False` in GdsWriteSettings.
...
- add pins and `snap_references_to_grid` [PR](https://github.com/gdsfactory/gdsfactory/pull/1674)
...
- add snap_references_to_grid as a write_gds flag [PR](https://github.com/gdsfactory/gdsfactory/pull/1211)
- add non-manhattan routing doc and document snap_references_to_grid docs [PR](https://github.com/gdsfactory/gdsfactory/pull/1214)
...
- Recursively netlist transformed (flattened) references [PR](https://github.com/gdsfactory/gdsfactory/pull/772) enables recursive netlisting of references which have been transformed and flattened via the snap_references_to_grid decorator, such that they can be properly simulated, i.e. with sax.
...
- rename `gdsfactory/snap_references_to_grid.py` to `gdsfactory/decorators.py`
- add test to snap_references_to_grid and include documentation in the [PDK docs](https://gdsfactory.github.io/gdsfactory/notebooks/08_pdk.html#)
