...
!git config --global user.email "user@gmail.com" # Replace user with your email.
```
<!-- #endregion -->
...
![key](images/git_key.png)
![key2](images/git_key2.png)
...
Let us do a little bit more work... Again, in practice you will be editing the files by hand, here we do it via shell commands for the sake of automation (and therefore the reproducibility of this tutorial!)
