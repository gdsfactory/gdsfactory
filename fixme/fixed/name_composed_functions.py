"""Function names come from hashing their parameters
sometimes we use functions as parameters for a function

composing functions is a convenient way to combine functions
"""
