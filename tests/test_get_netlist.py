...
def test_to_yaml_cell_array() -> None:
    rows = 3
    ...
    n = c.to_yaml(allow_multiple=True)
...
def test_to_yaml_cell_array_no_ports() -> None:
    rows = 3
    c = gf.components.array(
...
def test_to_yaml_cell_array_connecting() -> None:
    c = gf.components.array(
    ...
    with pytest.warns(UserWarning):
        ...
        c.to_yaml(allow_multiple=False)


def test_to_yaml_simple() -> None:
    c = gf.Component()
...
def test_to_yaml_promoted() -> None:
    c = gf.Component()
    i1 = c.add_ref(gf.components.straight(), "i1")
    i2 = c.add_ref(gf.components.straight(), "i2")
    i3 = c.add_ref(gf.components.straight(), "i3")
...
def test_to_yaml_close_enough_fails() -> None:
...
def test_to_yaml_close_enough_orthogonal_fails() -> None:
    c = gf.Component()
    i1 = c.add_ref(gf.components.straight(), "i1")
    i2 = c.add_ref(gf.components.straight(), "i2")
    i2.connect("o2", i1.ports["o1"])
...
def test_to_yaml_close_enough_rotated() -> None:
    c = gf.Component()
    i1 = c.add_ref(gf.components.straight(), "i1")
    i2 = c.add_ref(gf.components.straight(), "i2")
    i2.connect("o2", i1.ports["o1"])
...
def test_to_yaml_throws_error_bad_rotation() -> None:
    c = gf.Component()
    i1 = c.add_ref(gf.components.straight(), "i1")
    i2 = c.add_ref(gf.components.straight(), "i2")
    i2.connect("o2", i1.ports["o1"])
...
def test_to_yaml_electrical_simple() -> None:
    c = gf.Component()
...
def test_to_yaml_electrical_rotated_joint() -> None:
    c = gf.Component()
    i1 = c.add_ref(gf.components.wire_straight(), "i1")
    i2 = c.add_ref(gf.components.wire_straight(), "i2")
    i2.connect("e2", i1.ports["e1"])
...
def test_to_yaml_electrical_different_widths() -> None:
...
def test_to_yaml_transformed() -> None:
    rotation_value = 35
    c = gf.Component()
    i1 = c.add_ref(gf.components.straight(), "i1")
    i2 = c.add_ref(gf.components.straight(), "i2")
