...
from gdsfactory.to_schematic import to_schematic_recursive


def test_no_effect_on_original_components():
    passive_mzi = gf.components.mzi2x2_2x2()
    passive_mzi_phase_shifter_netlist_electrical = to_schematic_recursive(
...
def test_n_netlists():
    c = hcomponent_top()
    netlists = to_schematic_recursive(c)
