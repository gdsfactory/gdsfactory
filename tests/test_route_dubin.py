...
def test_route_dubin_array() -> None:
    ...
    comp1 = c << gf.components.nxn(west=0, east=10, xsize=10, ysize=100, layer=(30, 0), wg_width=3.2)
    comp2 = c << gf.components.nxn(west=0, east=10, xsize=10, ysize=100, layer=(30, 0), wg_width=3.2)
