...
def xsection(func):
    """Auxiliary decorator which automatically registers cross sections.

    This function also enforces the name of the cross section to be the same
    as the function that created it if the calling function was called with
    default arguments.
